...
import { CalendarIcon, HomeIcon, MailIcon, MapPin } from "lucide-react";
    ...
    return (
        <div>
            <div className="flex items-center">
                ...
                <p className="font-medium">Iloilo, Philippines</p>
            </div>
        </div>
    );
}
...
export function AnimatedTime() {
    ...
    return <div className="font-medium">{isMounted ? formattedTime : ""}</div>;
}
